...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Via Expressa Intranet - Editar Noticia</title>
  ...
  <div class="collapse navbar-collapse" id="conteudoNavbarSuportado">
     ...
     <script>
          ...
          <div class="sidebar-sticky">
			...
			?>
              ...
              <li class="nav-item">
                ...
                <button type="submit" style="width: 20vw; font-size: 12px; overflow: hidden;" name="idDaNoticia" value="<?php echo $dado['id_noticia']; ?>" class="btn btn-light btn-lg btn-block"><?php echo $dado['titulo']; ?></button>
				</form>
              </li>
			  <?php } ?>
            </ul>
	  ...
	  <div class="postarNoticia">
		...
		<form enctype="multipart/form-data" action="processanoticia.php" method="post">
			...
			<div class="form-group">
			<textarea  id="conteudo" class="form-control" id="exampleFormControlTextarea1" placeholder="Conteudo" rows="10"></textarea>
			</div>
			<div class="form-group">
      ...
      <div class="teste">
        <p>Data inicial: <input type="date" name="" value=""> Data final: <input type="date" name="" value=""> </p>
      </div>
			<div class="teste">
			<input onchange="mostra1()" style="display: none" type="file" class="form-control-file" id="exampleFormControlFile1">
			</div>
			<div class="teste">
			<input onchange="mostra2()" style="display: none" type="file" class="form-control-file" id="exampleFormControlFile1">
			</div>
	...
	<div class="postarNoticia">
		<h3>Notic&iacute;a</h3>
		<form enctype="multipart/form-data" action="atualizaNoticia.php" method="post">
			<div class="form-group">
			<input type="text" name="titulo" class="form-control" value="<?php echo $dado['titulo']; ?>" id="exampleFormControlInput1" placeholder="Titulo">
			</div>
			<div class="form-group">
			<textarea  id="conteudo" name="conteudo" class="form-control" value="" id="exampleFormControlTextarea1" placeholder="Conteudo" rows="10"><?php echo $dado['conteudo']; ?></textarea>
			</div>
			<div class="form-group">
			<label for="exampleFormControlFile1">Imagem de referencia</label>
			<input type="file" name="ref" class="form-control-file" id="exampleFormControlFile1">
			</div>
			<div class="teste">
			<label for="exampleFormControlFile1">Imagens do conteudo</label>
			<input type="file" name="img" class="form-control-file" id="exampleFormControlFile1">
			</div>
      		<div class="teste">
        		<p>Data inicial: <input type="date" name="dtInicial" value="<?php echo $dado['dtInicio']; ?>"> Data final: <input type="date" name="dtFim" value="<?php echo $dado['dtFim']; ?>"> </p>
      		</div>
			<div class="teste">
			<input onchange="mostra1()" name="img1" style="display: none" type="file" class="form-control-file" id="exampleFormControlFile1">
			</div>
			<div class="teste">
			<input onchange="mostra2()" name="img2" style="display: none" type="file" class="form-control-file" id="exampleFormControlFile1">
			</div>
			<button type="submit" name="idNoticia" value="<?php echo $id; ?>" class="btn btn-primary btn-lg btn-block">Confirmar</button>
		</form>
		</div>
		<?php } ?>
